# reference: https://github.com/avivcaspi/TennisProject/blob/main/src/court_reference.py
...
class CourtReference:
    ...
    def __init__(self):
        ...
        self.court = cv2.cvtColor(cv2.imread('../images/court_configurations/court_reference.png'), cv2.COLOR_BGR2GRAY)
    ...
    def build_court_reference(self):
        ...
        plt.imsave('../images/court_configurations/court_reference.png', court, cmap='gray')
        self.court = court
        return court
    ...
    def save_all_court_configurations(self):
        ...
        for i, conf in self.court_conf.items():
            ...
            cv2.imwrite(f'../images/court_configurations/court_conf_{i}.png', c)
